...
myloc=$(pwd)
data_dir=/mnt/z/Marilyne/Axioscan/6-Dhivya/split/No_Scene/
...
dedust_out=/mnt/e/CycIF_analysis/registration_outputs/test_de-dusted/
prereg_out=/mnt/e/CycIF_analysis/registration_outputs/test/
restitched_out=/mnt/e/CycIF_analysis/registration_outputs/test_restitched/
